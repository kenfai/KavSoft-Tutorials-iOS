        ...
        ZStack {
            VStack {
                ...
                ZStack(alignment: Alignment(horizontal: .center, vertical: .top)) {
                    LinearGradient(gradient: Gradient(colors: gradient1), startPoint: .top, endPoint: .bottom)
                    ...
                    VStack {
                        Button(action: {
                            ...
                            .padding(50)
                            .background(
                                LinearGradient(gradient: Gradient(colors: [Color("pgradient1"), Color("pgradient2")]), startPoint: .top, endPoint: .bottom)
                            )
                            .clipShape(Circle())
                            .padding(15)
                            .background(Color("power1").opacity(0.8))
                            .clipShape(Circle())
                            .padding(15)
